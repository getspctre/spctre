  ...
  components: {
    ...
    schemas: {
      ...
      PublicationAttestationIngestRequest: {
        type: "object",
        required: ["idempotencyKey", "attestation"],
        description:
          "Framework-agnostic publication facts. Clients submit normalized facts bound to a previously retained byte-exact artifact; the server never fetches a URL, renders a page, or adjudicates compliance.",
        properties: {
          ...
          attestation: {
            ...
            additionalProperties: true,
            properties: {
              schema: { type: "string", enum: ["spctre.publication-attestation.v1"] },
              attestationId: { type: "string", format: "uuid" },
              supersedes: { type: "string", format: "uuid" },
              content: {
                type: "object",
                required: ["hash", "artifactRef", "version", "identity", "modality"],
                properties: {
                  hash: { type: "string", pattern: "^sha256:[0-9a-f]{64}$" },
                  artifactRef: { type: "string", pattern: "^sha256:[0-9a-f]{64}$" },
                  version: { type: "string", minLength: 1 },
                  identity: { type: "string", minLength: 1 },
                  modality: { type: "string", enum: ["text", "image", "audio", "video", "other"] },
                },
              },
              generation: { type: "object", additionalProperties: true },
              editorial: { type: "object", additionalProperties: true },
      ...
      PublicationAttestationIngestResponse: {
        type: "object",
        required: ["attestationId", "deduplicated", "receiptVerified", "meta"],
        properties: {
          attestationId: { type: "string", format: "uuid" },
          deduplicated: { type: "boolean" },
          receiptVerified: { type: "boolean", nullable: true },
          meta: { $ref: "#/components/schemas/ApiMeta" },
        },
      },
      ...
      PublicationAttestationRecord: {
        ...
        properties: {
          ...
          policyContext: { type: "object", additionalProperties: { type: "string" } },
      ...
      PublicationSigningKeyChallengeRequest: {
        type: "object",
        required: ["entityRef", "keyId", "publicKey"],
        properties: {
          entityRef: { type: "string", pattern: "^entity:[A-Za-z0-9._:-]+$" },
      ...
      PublicationSigningKeyEnrollRequest: {
        allOf: [
          { $ref: "#/components/schemas/PublicationSigningKeyChallengeRequest" },
          {
            type: "object",
            required: ["challengeId", "proof"],
            properties: {
              challengeId: { type: "string", format: "uuid" },
              replacesKeyId: { type: "string", format: "uuid" },
      ...
      EscalationStatusResponse: {
        ...
        properties: {
          ...
          approvedToolParameters: {
            ...
            additionalProperties: true,
            description:
              "Confirmation of the decision arguments a human reviewed — not an execution source. Sensitive keys are redacted and depth/size are bounded when the decision is recorded, so this is a lossy snapshot: execute from your own parameters and use this to confirm they match what was approved. Present only when the escalation is RESOLVED with a PROCEED outcome.",
          },
          credentialGrant: { $ref: "#/components/schemas/CredentialGrant" },
          meta: { $ref: "#/components/schemas/ApiMeta" },
        },
      ...
      PolicyImportRequest: {
        ...
        properties: {
          source: {
            ...
            minLength: 1,
            description:
              "Policy source. AGT YAML/JSON is accepted directly; the documented Rego and Cedar subsets are translated into AGT-compatible rules before review.",
          },
          sourceFormat: {
            type: "string",
  ...
  paths: {
    ...
    "/workspaces": {
      get: {
        ...
        summary: "List the workspaces a credential can reach",
        "x-spctre-plan": "oss",
        tags: ["Operations"],
        responses: {
          "200": { description: "Workspaces visible to the caller." },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    },
    "/members": {
      get: {
        ...
        summary: "List the members of the active workspace",
        "x-spctre-plan": "oss",
        tags: ["Operations"],
        responses: {
          "200": { description: "Members of the active workspace." },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    },
    "/approvals/queue": {
      get: {
        ...
        tags: ["Review"],
        responses: {
          "200": { description: "Approvals awaiting a reviewer." },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    },
    "/compliance/status": {
      get: {
        ...
        summary: "Report the published compliance packet's status",
        description:
          "Answers 200 with `available: false` when no policy revision has been published, rather than 404: the absence of a packet is a reportable state, not a missing resource.",
        "x-spctre-plan": "oss",
        tags: ["Compliance"],
        responses: {
          "200": { description: "Compliance status, which may report no published packet." },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    },
    "/agents/{id}/audit": {
      get: {
        ...
        summary: "Summarise one agent's governed decisions",
        "x-spctre-plan": "oss",
        tags: ["Operations"],
        parameters: [
          {
        ...
        responses: {
          "200": {
            description:
              "Decisions and a summary carrying allowed/blocked/warned/escalated counts and a compliance status.",
          },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    ...
    "/trust/history": {
      get: {
        ...
        summary: "List an agent's trust-score history",
        "x-spctre-plan": "oss",
        tags: ["Trust"],
        parameters: [
          {
        ...
        responses: {
          "200": { description: "Trust events for the agent, most recent first." },
          "400": { $ref: "#/components/responses/BadRequest" },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    ...
    "/identity/events": {
      get: {
        ...
        summary: "List identity lifecycle events",
        "x-spctre-plan": "oss",
        tags: ["Operations"],
        parameters: [
        ...
        responses: {
          "200": { description: "Identity lifecycle events." },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    },
    "/workflow/config": {
      get: {
        ...
        summary: "Read the workspace's review workflow configuration",
        "x-spctre-plan": "oss",
        tags: ["Review"],
        parameters: [
        ...
        responses: {
          "200": { description: "Workflow configuration for the workspace." },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    },
    "/gateway-ingest/mcp": {
      post: {
        operationId: "ingestMcpGatewayEvent",
        summary: "Ingest an MCP gateway event",
        description:
          "The MCP member of the gateway-ingest family, alongside the Helicone, LiteLLM, Notion, and Portkey receivers.",
        "x-spctre-plan": "oss",
        tags: ["Gateway"],
        requestBody: {
          required: true,
        ...
        responses: {
          ...
          "201": { description: "Event accepted and evidence recorded." },
          "400": { $ref: "#/components/responses/BadRequest" },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    ...
    "/ingest/providers/docker_ai_governance": {
      post: {
        operationId: "ingestDockerAiGovernanceEvidence",
        summary: "Ingest a Docker AI Governance audit file or single audit event",
        description:
          "Concrete managed-provider route for Docker AI Governance. It deliberately shadows the generic managed-provider route so a shipper can send a sealed JSONL audit file as one bounded request; a JSON body remains compatible with the one-record managed-provider contract.",
        "x-spctre-plan": "oss",
        tags: ["Evidence"],
        security: [{ bearerAuth: [] }],
        parameters: [
    ...
    "/evidence/publication-artifacts": {
      post: {
        operationId: "retainPublicationContentArtifact",
        summary: "Retain a byte-exact publication content artifact",
        description:
          "Stores exact publication bytes addressed by X-Spctre-Content-Hash. The artifact must be retained before a publication attestation can reference it.",
        "x-spctre-plan": "oss",
        tags: ["Evidence"],
        security: [{ bearerAuth: [] }],
        parameters: [
        ...
        responses: {
          "201": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/PublicationContentArtifactRetainResponse" },
              },
            },
          },
          "400": { $ref: "#/components/responses/BadRequest" },
    ...
    "/evidence/publication-artifacts/{hash}": {
      get: {
        operationId: "exportPublicationContentArtifact",
        summary: "Export a retained publication artifact",
    ...
    "/evidence/publications": {
      get: {
        operationId: "listPublicationAttestations",
        summary: "List immutable publication attestations",
      ...
      post: {
        operationId: "ingestPublicationAttestation",
        summary: "Ingest immutable publication facts",
        description:
          "Accepts normalized publication facts bound to a retained artifact. The server validates shape, artifact binding, authorization, idempotency, and optional receipt signatures; it does not adjudicate legal compliance.",
        "x-spctre-plan": "oss",
        tags: ["Evidence"],
        security: [{ bearerAuth: [] }],
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/PublicationAttestationIngestRequest" },
            },
          },
        },
        responses: {
          "201": {
            ...
            content: {
              "application/json": {
                schema: { $ref: "#/components/schemas/PublicationAttestationIngestResponse" },
              },
            },
          },
          "200": {
    ...
    "/evidence/publications/{id}": {
      get: {
        operationId: "getPublicationAttestation",
        summary: "Get an immutable publication attestation",
        "x-spctre-plan": "oss",
        tags: ["Evidence"],
        security: [{ bearerAuth: [] }],
        parameters: [
          ...
          "200": {
            ...
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  required: ["attestation", "meta"],
                  properties: {
                    attestation: { $ref: "#/components/schemas/PublicationAttestationRecord" },
                    meta: { $ref: "#/components/schemas/ApiMeta" },
                  },
                },
              },
    ...
    "/evidence/publication-signing-keys/challenges": {
      post: {
        operationId: "createPublicationSigningKeyChallenge",
        summary: "Create a signing-key possession challenge",
        "x-spctre-plan": "oss",
        tags: ["Evidence"],
        security: [{ bearerAuth: [] }],
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/PublicationSigningKeyChallengeRequest" },
            },
          },
        },
        responses: {
    ...
    "/evidence/publication-signing-keys": {
      get: {
        operationId: "listPublicationSigningKeys",
        summary: "List trusted publication signing keys",
        "x-spctre-plan": "oss",
        tags: ["Evidence"],
        security: [{ bearerAuth: [] }],
        parameters: [
          {
            name: "entityRef",
            in: "query",
            schema: { type: "string", pattern: "^entity:[A-Za-z0-9._:-]+$" },
          },
        ],
        responses: {
          "200": { description: "Signing keys." },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
      post: {
        operationId: "enrollPublicationSigningKey",
        summary: "Enroll or rotate an ownership-verified signing key",
        "x-spctre-plan": "oss",
        tags: ["Evidence"],
        security: [{ bearerAuth: [] }],
        requestBody: {
          ...
          content: {
            "application/json": {
              schema: { $ref: "#/components/schemas/PublicationSigningKeyEnrollRequest" },
            },
          },
        },
        responses: {
          "201": { description: "Signing key enrolled." },
          "400": { $ref: "#/components/responses/BadRequest" },
          "401": { $ref: "#/components/responses/Unauthorized" },
        },
      },
    ...
    "/evidence/publication-signing-keys/{id}": {
      delete: {
        operationId: "revokePublicationSigningKey",
        summary: "Revoke an enrolled publication signing key",
        "x-spctre-plan": "oss",
        tags: ["Evidence"],
        security: [{ bearerAuth: [] }],
        parameters: [
        ...
        responses: {
          "200": { description: "Signing key revoked." },
          "401": { $ref: "#/components/responses/Unauthorized" },
          "404": { $ref: "#/components/responses/NotFound" },
        },
      },
    ...
    "/bundle/latest/custody": {
      post: {
        operationId: "retainLatestPublishedBundle",
        summary: "Retain exact bytes of the latest published policy bundle",
        description:
          "Materializes the exact raw bundle bytes under their SHA-256 content hash and links them atomically to the immutable policy publication event. This is distinct from the semantic artifact hash and is safe to call repeatedly.",
        "x-spctre-plan": "oss",
        tags: ["Bundle"],
        security: [{ bearerAuth: [] }],
        responses: {
          "201": {
            ...
            content: {
              "application/json": {
                schema: {
                  type: "object",
                  required: ["contentHash", "publishId", "retained", "meta"],
                  properties: {
                    contentHash: { type: "string", pattern: "^sha256:[0-9a-f]{64}$" },
