...
export const spacing = { xxs: "4px", xs: "8px", sm: "12px", md: "16px", lg: "24px" } as const;

export const radius = { sm: "7px", md: "8px", full: "999px" } as const;
...
export const elevation = { panel: "0 18px 44px oklch(0.2 0.02 250 / 0.18)" } as const;
