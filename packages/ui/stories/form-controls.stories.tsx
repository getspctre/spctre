...
const meta = { title: "Primitives/FormControls", component: FormField } satisfies Meta<
  typeof FormField
>;
  ...
  render: () => (
    <div style={{ display: "grid", gap: 12, maxWidth: 560 }}>
      <FormField label="Workflow name" hint="Use a name that explains the policy intent.">
        <TextInput
          placeholder="Example: Finance export approvals"
          defaultValue="Finance export approvals"
        />
      </FormField>
      ...
      <FormField label="Why this change" hint="Included in the audit log for reviewer context.">
        <TextArea
          rows={4}
          defaultValue="Requiring Security + Finance approvals for payment export policy updates."
        />
      </FormField>
    </div>
  ),
