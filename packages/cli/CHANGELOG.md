...
- Updated dependencies [8f80d92]
  - @spctre/policy-schema@0.9.0

## 0.5.0

### Minor Changes

- 9dde56c: Expose the public REST API v1 through `spctre api`, including focused commands
  for policy evaluation, reviews, compliance, verification, and operations. Migrate
  all CLI and generated-adapter public API traffic to `/api/v1`.
- ff630a3: Support the Kimi Code CLI harness in `install-hook`, `install-skill`, and `pretooluse`.
...
- Updated dependencies [2fd313a]
  - @spctre/policy-schema@0.8.0

## 0.4.3

### Patch Changes

- 67584b1: `spctre cloud login --trial` no longer prints the trial's capacity and retention
...
- Updated dependencies [9e581ec]
  - @spctre/policy-schema@0.7.0
