  ...
  return (
    <>
      <div className="reviewTabsNav">
        ...
        {publishLocked ? (
          <p className="meta reviewStageHint">
            <Lock size={13} aria-hidden="true" /> Compose the revision in Review changes to unlock
            approvals and publish readiness.
          </p>
        ) : null}
      </div>
      {activeStage === "review" &&
        ...
        (publishContent ?? (
          <section className="panel reviewPanel">
            <div className="emptyState">
              ...
              <p className="meta">
                Approvals and publish readiness become available after composing the policy bundle.
                Go to{" "}
                <a className="button buttonSmall" href={reviewHref} style={{ display: "inline" }}>
                  Review changes
                </a>{" "}
